...
<head>
   <meta charset="utf-8">
    ...
    <!-- Navbar brand -->
    <a class="navbar-brand" href="#">geekyStack</a>
    ...
    ?>
        ...
        <div class="card card-body">
            ...
            <h4 class="card-title"><?php echo '<span class="badge red">'.$row['name'].'</span>' ?></h4>
            ...
            <form method=post>
                ...
                <input type="submit"  class="form-control btn btn-primary black" name=submit value="Recommend" \>
